...
[Rejstřík](../README.md) | [Zpět](0002.md) | [Další](0004a.md)
...
> [!NOTE]
> Generátory slotů i lokací jsou dostupné pouze pro eventy které mají status "In preparation" a je možné jimi vygenerovat maximálně 100 záznamů na jedno spuštění.
...
> [!IMPORTANT]  
> Zde prosím velice opatrně, rozesílání emailů se může rozbít v případě, že v syntaxi šablon bude nějaká chyba v syntaxi ⚠️
...
Pro zakládání uživatelů doporučujeme používat **[importní formulář](0004a.md)** nebo **[import pomocí API](0004b.md)**, který se o veškeré potřebné vazby postará.
...
Poté je možné kontaktovat NIX.cz s informací o tom, že je vše nachystané a domluvit se na spuštění automatického rozesílání zpráv *(Zapnout automatické rozesílání fronty zpráv můžete i sami zaškrtnutím checkboxu "Enable periodical sending" v modulu [Global Configuration](0010.md), avšak doporučujeme se nám ozvat, že aplikace je připravena pro nasazení na ostrý provoz)*.
