...
Emaily s touto šablonou se používají ve chvíli, kdy některý z účastníků eventu odešle osobní emailovou pozvánku uživateli, který ještě nemá aktivovanou svou registraci
...
<!-- POUZE V REGWEBU **Send Copy To** - Seznam emailových adres *(oddělené novým řádkem)*, na které se mají posílat kopie pokaždé když je šablona odeslána.-->
